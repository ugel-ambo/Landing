...
export default async function FortalecimientoCebaPage() {
    const data = await getFortalecimientos("ceba");
        ...
        <main className="min-h-screen bg-gray-50/50">
            <div className="w-full bg-[#049DD9] py-12 md:py-20">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-blue-100 text-lg max-w-2xl">
                        Recursos, cursos y materiales de capacitación para docentes de CEBA.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 relative -mt-10">
                <div className="bg-white rounded-3xl shadow p-6">
                    <FortalecimientoView initialData={data} area="CEBA" />
                </div>
            </div>
        </main>
    );
