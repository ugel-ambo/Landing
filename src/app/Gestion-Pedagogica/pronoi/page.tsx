          ...
          <div className="relative z-20 h-full flex flex-col items-center justify-start pt-10 sm:pt-32 md:pt-24 px-4 lg:pt-10 xl:pt-24 sm:px-6 md:px-8">
            ...
            <div className="flex flex-col w-full max-w-6xl items-center lg:items-start xl:pt-10 2xl:pt-5 2xl:items-start lg:mr-20 2xl:mr-72">
              ...
              <p className="mb-8 max-w-lg text-base sm:text-lg md:text-xl text-white drop-shadow-md font-medium text-left">
                Portal de recursos pedagógicos y gestión para docentes del nivel
                inicial. Acompañamiento permanente para la mejora de los
                aprendizajes.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/Gestion-Pedagogica/pronoi/fortalecimiento">
                  <Button
                    size="lg"
                    className="bg-white text-[#049DD9] hover:bg-blue-50 font-semibold text-base shadow-lg"
                  >
            ...
            {/* Floating Elements */}
            <div className="hidden sm:block absolute top-8 left-8 md:left-12 text-2xl md:text-3xl animate-bounce opacity-80">
              ✏️
            </div>
            <div
      ...
      <section className="py-20 px-6 sm:px-8 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-900 mb-4">
            Servicios para Promotoras y Docentes PRONOEI
          </h2>
          <p className="text-lg text-gray-600 mb-12">
            Herramientas y recursos para fortalecer tu práctica pedagógica en
            educación inicial no escolarizada
          </p>
            ...
            {[
              {
                ...
                desc: "Modelos y formatos adaptados a la modalidad no escolarizada",
              },
              {
                icon: "🎓",
                title: "Capacitaciones",
                desc: "Formación continua para promotoras educativas comunitarias",
              },
              {
                icon: "📊",
                title: "Evaluación",
                desc: "Instrumentos de seguimiento y evaluación del desarrollo infantil",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="p-6 rounded-lg bg-blue-50 border-2 border-blue-200 hover:shadow-lg transition"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-4">
                El Programa No Escolarizado de Educación Inicial (PRONOEI)
                brinda atención educativa a niños y niñas de 3 a 5 años en zonas
                rurales y urbano-marginales donde no existe cobertura de
                educación inicial escolarizada.
              </p>
              <p className="text-lg text-gray-700 mb-4">
                A través de promotoras educativas comunitarias capacitadas,
                ofrecemos una educación de calidad que promueve el desarrollo
                integral de los niños en espacios comunitarios adaptados.
              </p>
              <p className="text-lg text-gray-700">
                Trabajamos en coordinación con las familias y la comunidad para
                garantizar que cada niño y niña reciba la estimulación y
                atención necesaria para su desarrollo óptimo.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-6">
              {[
                { number: "25+", label: "PRONOEI Activos" },
                ...
                <div
                  key={i}
                  className="bg-white p-6 rounded-lg shadow-md text-center border-2 border-blue-100"
                >
                  <div className="text-4xl font-bold text-[#049DD9] mb-2">
                    {stat.number}
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Accede a herramientas y materiales diseñados especialmente para la
              educación inicial no escolarizada
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: "�",
                title: "Guías para Promotoras",
                desc: "Materiales de apoyo para la planificación de actividades",
              },
              {
                icon: "🎨",
                title: "Actividades Lúdicas",
                desc: "Estrategias de aprendizaje a través del juego libre",
              },
              {
                icon: "👪",
                title: "Trabajo con Familias",
                desc: "Estrategias para involucrar a padres y madres",
              },
              {
                icon: "🎯",
                title: "Evaluación del Desarrollo",
                desc: "Herramientas para el seguimiento del desarrollo infantil",
              },
              {
                icon: "🏡",
                title: "Gestión de Espacios",
                desc: "Organización de ambientes educativos comunitarios",
              },
              {
                icon: "💡",
                title: "Materiales Educativos",
                desc: "Elaboración de recursos con material reciclado",
              },
              {
                icon: "🌟",
                title: "Atención a la Diversidad",
                desc: "Recursos para la inclusión educativa",
              },
              {
                icon: "🔍",
                title: "Acompañamiento",
                desc: "Herramientas de monitoreo y acompañamiento",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="p-5 rounded-lg bg-linear-to-br from-blue-50 to-white border border-blue-200 hover:shadow-lg transition hover:border-[#049DD9]"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="p-8 rounded-lg bg-white border-2 border-blue-200 hover:shadow-xl transition"
              >
