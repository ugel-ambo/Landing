...
export default async function FortalecimientoSecundariaPage() {
    const data = await getFortalecimientos("secundaria");
        ...
        <main className="min-h-screen bg-gray-50/50">
            ...
            <div className="container mx-auto px-4 relative -mt-10">
                <div className="bg-white rounded-3xl shadow p-6">
                    <FortalecimientoView initialData={data} area="Educación Secundaria" />
                </div>
            </div>
        </main>
