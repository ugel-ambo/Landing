...
const areaStaticData = {
  hero: {
    ...
    description:
      "Conducimos la formulación del Proyecto Educativo Local y acompañamos los procesos de innovación.",
    image: "/Directorio/agi/general.JPG",
    leaderName: "Kennedy Robinson Eulogio Valenzuela",
    leaderPosition: "Jefe de Planeamiento y Desarrollo Institucional",
  },
  functionsIntro:
    "Diseñamos estrategias e instrumentos para el crecimiento educativo de la provincia.",
  teamIntro:
    "Equipo multidisciplinario que impulsa proyectos y evalúa la gestión institucional.",
  functions: [
...
const fallbackEmployees = [
  {
    id: "1",
    name: "Kennedy Robinson Eulogio Valenzuela",
...
async function getEmployeesFromDB() {
  try {
    ...
    const personal = (await PersonalModel.find({ area: "agi" })
      .populate("foto")
      .sort({ orden: 1 })
