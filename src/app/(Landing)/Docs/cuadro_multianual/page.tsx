...
export default function CuadroMultianualPage() {
                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Documento oficial del Cuadro Multianual de Necesidades de la UGEL
                        </p>
                    </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-blue-100 overflow-hidden">
                            ...
                            <div className="overflow-hidden bg-gray-50" style={{ height: 'calc(100vh - 250px)' }}>
                                <iframe
                                    ...
                                    title="Cuadro Multianual de Necesidades"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="fixed inset-0 z-50 bg-black">
                    <div className="relative w-full h-full">
                        ...
                        <div className="absolute top-0 left-0 right-0 bg-black/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between z-10">
                            <h2 className="text-white font-semibold">Cuadro Multianual de Necesidades</h2>
                            <Button
                                variant="ghost"
                                size="sm"
