...
export default function NewsSection() {
  ...
  const loadNews = async () => {
    try {
      ...
      // Tomamos exactamente 6 noticias para llenar las 2 filas de 3
  ...
  return (
    <section id="noticias" className="py-8 md:py-10 bg-muted/30 w-full">
      <div className="w-full px-4 md:px-10">
        ...
        {/* Grid ajustado a 3 columnas constantes en desktop */}
...
//           console.warn(
//             "NewsSection - AI formatting failed, status=",
//             aiResponse.status,
//             "body=",
//             text
//           );
...
//       console.log(
//         "NewsSection - Noticias transformadas:",
...
//   return (
//     <section id="noticias" className="py-8 md:py-10 bg-muted/30">
//       <div className="container mx-auto px-4">
//         <div className="text-center mb-8 md:mb-12">
