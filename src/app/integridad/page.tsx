...
import NoticiaIntegridad, {
  INoticiaIntegridad,
  getImageUrl,
} from "@/models/NoticiaIntegridad";
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative w-full h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-[#049DD9]/20 to-[#223F59]/20" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-4 drop-shadow-2xl">
            <span className="bg-clip-text text-transparent bg-linear-to-t from-white via-[#F2F2F2] to-white">
              Integridad
            </span>
          </h1>

          <p className="text-lg md:text-xl max-w-2xl text-gray-200 mb-8">
            Comprometidos con la transparencia, ética y la lucha contra la
            corrupción en la gestión educativa
          </p>
      ...
      <section
        id="quienes-somos"
        className="py-10 md:py-10 bg-linear-to-b from-white to-muted/30"
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Somos el área encargada de promover la integridad, transparencia y
              la lucha contra la corrupción en la Unidad de Gestión Educativa
              Local de Ambo.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <Card className="border-2 hover:border-[#049DD9]/50 hover:shadow-lg transition-all duration-300 group">
              <CardContent className="p-6 text-center">
                <div className="inline-flex p-4 bg-linear-to-br from-[#049DD9]/10 to-[#049DD9]/5 rounded-2xl mb-4 group-hover:scale-110 transition-transform">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Mantente informado sobre las acciones y actividades en materia de
              integridad
            </p>
          </div>
            ...
            <Card className="max-w-2xl mx-auto border-dashed border-2">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  Aún no hay noticias publicadas. Pronto compartiremos
