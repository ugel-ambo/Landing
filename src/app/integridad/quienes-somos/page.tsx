...
const valores = [
  {
    ...
    title: "Justicia",
    description:
      "Actuamos con equidad e imparcialidad en todas nuestras decisiones y procesos",
  ...
  },
  {
    ...
    title: "Honestidad",
    description:
      "Garantizamos la veracidad y transparencia en toda nuestra gestión",
  ...
  },
  {
    ...
    description:
      "Cumplimos con nuestros compromisos y rendimos cuentas de nuestras acciones",
  ...
  },
  {
    ...
    title: "Respeto",
    description:
      "Valoramos la dignidad de todas las personas y promovemos la inclusión",
...
export default function QuienesSomosIntegridad() {
  return (
    <main className="min-h-screen bg-linear-to-b from-slate-50 to-white overflow-hidden">
      <Menu />

      {/* Header con formas orgánicas */}
      <section className="relative bg-linear-to-br from-[#049DD9] via-[#0380B3] to-[#223F59] py-20 md:py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
              ...
              de la UGEL Ambo es la unidad responsable de promover y fortalecer
              la cultura de integridad, transparencia y lucha contra la
              corrupción en nuestra institución. Trabajamos para garantizar una
              gestión educativa ética y eficiente, implementando políticas de
              prevención, gestionando canales de denuncia y capacitando al
              personal en temas de ética pública, todo ello al servicio de la
              comunidad educativa de la provincia.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative">
        {/* Fondo decorativo */}
        <div className="absolute inset-0 bg-linear-to-b from-slate-50 via-cyan-50/30 to-slate-50" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <div className="h-1.5 w-24 bg-linear-to-r from-[#049DD9] to-cyan-400 mx-auto rounded-full" />
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {valores.map((valor, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-linear-to-br ${valor.linear} rounded-3xl opacity-0 group-hover:opacity-10 blur-xl transition-all duration-500`}
                  />
                  <div className="relative bg-white p-8 rounded-3xl border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-full flex flex-col">
                    <div
                      className={`inline-flex p-4 bg-linear-to-br ${valor.linear} rounded-2xl mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 self-start`}
                    >
      ...
      <section className="py-20 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="h-1.5 w-24 bg-linear-to-r from-emerald-500 to-teal-400 mx-auto rounded-full" />
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-4 lg:gap-6">
              {funciones.map((funcion, index) => (
                ...
                >
                  <div className="absolute top-0 left-0 w-1 h-full bg-linear-to-b from-[#049DD9] to-cyan-400 rounded-l-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="flex items-start gap-4">
                    <div className="shrink-0 w-10 h-10 bg-linear-to-br from-[#049DD9]/10 to-cyan-400/10 rounded-xl flex items-center justify-center group-hover:from-[#049DD9] group-hover:to-cyan-400 transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Principales normas que sustentan nuestra labor en materia de
              integridad
            </p>
          </div>
      ...
      {/* Contacto */}
      <section className="py-16 bg-linear-to-br from-[#223F59] to-[#049DD9]">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="/integridad">Volver a Integridad</Link>
            </Button>
          </div>
        </div>
      </section>
